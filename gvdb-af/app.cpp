...
void App::mouse(NVPWindow::MouseButton button, NVPWindow::ButtonAction state, int mods, int x, int y)
{
...
{
	return app.run ( "NVIDIA(R) GVDB Voxels - gResample", "resample", argc, argv, 1024, 768, 4, 5 );
}
